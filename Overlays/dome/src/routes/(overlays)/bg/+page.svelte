<script lang="ts">
	...
	import FullScreenThreeBg from '$lib/components/FullScreenThreeBg.svelte';
...
<svelte:head>
	<title>BG Overlay</title>
</svelte:head>

<FullScreenThreeBg free_cam_fov={config?.['caster_prefs']['free_cam_fov'] ?? 85} {camera_transform} />
